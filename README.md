...
Formica is based on the [Racket programming language](http://planet.racket-lang.org/), famous by its educational and practical use, and could be considered as a Racket teachpack.
