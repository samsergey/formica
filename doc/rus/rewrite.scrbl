...
Правила итеративных подстановок бывают либо @emph{регулярными}, либо @emph{терминальными}.
...
@itemize{
 @item{@racket[_datum] --- элементарные данные: числа, квотированные символы и выражения, строки. 
  ...
  @item{@racket[(_id _patt ...)] --- составные данные: @elemref["t:pair"]{пары}, 
         ...
         Символ @racket[_id] определяет тип данных и соответствует конструктору типа,
