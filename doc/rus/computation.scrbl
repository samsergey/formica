...
Ниже приводится алгоритм вычисления произвольного выражения:
...
@section[#:tag "curring"]{Каррирование}

Одним из отличий диалекта formica Racket от языка Racket является упрощённый синтаксис 
для каррирования и частичного применения функций.
...
@margin-note{Упрощённый синтаксис определён в библиотеке @racket[formica/c-app]}
